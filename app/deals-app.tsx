...
export default function DealsApp({ initialDeals = deals as Deal[] }: { initialDeals?: Deal[] }) {
  ...
  return (
    <main>
      ...
      <footer><a className="brand" href="#top"><span className="brand-mark">%</span><span>deals<span className="brand-dot">.</span></span></a><p>Smart savings for everyday India.<br /><span className="affiliate-disclosure">As an Amazon Associate I earn from qualifying purchases.</span></p><div><a href="#about">About</a><a href="#">Privacy</a><a href="#">Terms</a><a href="#">Contact</a></div><small>© 2026 deals.ads-ai.in</small></footer>
    </main>
  );
}
